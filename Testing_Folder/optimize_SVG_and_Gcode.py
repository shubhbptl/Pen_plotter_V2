...
subprocess.run(["vpype","read","/home/penplotter/Pen_plotter_V2/my_flask/static/Image_Storage/Images/IMG-0254.jpg", "write","--page-size","a3","--center", "print.svg"])
subprocess.run(["vpype", "read", "print.svg", "gwrite", "--profile", "my_own_plotter", "print.gcode"])
#--------------------------------------------------------------------------------------------------------------------
